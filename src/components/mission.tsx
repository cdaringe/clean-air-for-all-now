  ...
  return (
    <Card title="Mission Statement" {...props}>
      <p className="text-sm text-slate-700">
        ...
        emissions emitted from Intel {"New Mexico's"}{" "}
        plant by informing the public of their harmful effects and exhorting
        Intel to employ the best available emissions abatement equipment. Put
        people first.
      </p>
    </Card>
  );
